...
\item Repeat step 1 to step 3 with different values of K for $q$ times, each one is considered as a NDACP. %and $k_i's$ say for $q$ times.
...
%In the following section, we show results when the procedure is applied to five different datasets. 
 ...
 \caption{Non-Disclosed Aggregated Conformal Prediction (NDACP)} \label{algo:uACP}
